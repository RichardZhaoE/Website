<?php
	...
	{
		echo "Premium User Lists Available: ".count($fileList)." / 9<br>";
		...
		echo "<font color=red>List(s) for premium users are currently unavailable either due to maintaince or downtime.</font>";
	}
?>